...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='https://goo.gl/E4dvgP' target='_blank'><img src='http://idteck.vn/FileUpload/Images/maychamcongvantayidteck.jpg' width='500px'/><br/>Máy chấm công Vân tay IDTECK</a>. Liên hệ: 0913776733 <h2><a class='close-linhnguyen-modal'>X</a></h2>");
